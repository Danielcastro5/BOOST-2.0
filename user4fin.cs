...
namespace BOOST
{
	public partial class user4fin : Form
	{
		public user4fin()
		{
			InitializeComponent();
        ...
        private void user4fin_Load(object sender, EventArgs e)
        {
            // este evento es para poner la imagen circular
            System.Drawing.Drawing2D.GraphicsPath gp = new System.Drawing.Drawing2D.GraphicsPath();
            gp.AddEllipse(0, 0, fin4.Width - 3, fin4.Height - 3);
            fin4.Region = new Region(gp);
        }
    }
}
