...
namespace BOOST
{
	public partial class user3fin : Form
	{
		public user3fin()
		{
			InitializeComponent();
        ...
        private void user3fin_Load(object sender, EventArgs e)
        {

            // este evento es para poner la imagen circular
            System.Drawing.Drawing2D.GraphicsPath gp = new System.Drawing.Drawing2D.GraphicsPath();
            gp.AddEllipse(0, 0, fin3.Width - 3, fin3.Height - 3);
            fin3.Region = new Region(gp);
        }
    }
}
