...
namespace BOOST
{
	public partial class user2fin : Form
	{
		public user2fin()
		{
			InitializeComponent();
        ...
        private void user2fin_Load(object sender, EventArgs e)
        {

            // este evento es para poner la imagen circular
            System.Drawing.Drawing2D.GraphicsPath gp = new System.Drawing.Drawing2D.GraphicsPath();
            gp.AddEllipse(0, 0, fin2.Width - 3, fin2.Height - 3);
            fin2.Region = new Region(gp);
        }
    }
}
